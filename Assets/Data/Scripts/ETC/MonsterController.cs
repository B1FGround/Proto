...
public class MonsterController : MonoBehaviour
{
    ...
    public void Damaged(int damage)
    {
        ...
        if (hp <= 0)
        {
            ...
            pos.y += 0.5f;
            Instantiate(Resources.Load("Prefabs/Effect/DeadEffect"), pos, Quaternion.identity);
            OnDead.Invoke();
    ...
    private void MiniBossAttack()
    {
        ...
        if (curAttackRate >= attackRate)
        {
            ...
            for (int i = 0; i < attackCount; ++i)
            {
                ...
                GameObject bullet = Instantiate(Resources.Load("Prefabs/Object/MiniBossBullet"), transform.position, Quaternion.identity) as GameObject;
